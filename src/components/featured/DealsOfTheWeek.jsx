...
const DealsOfTheWeek = ({ products = [] }) => {
  ...
  return (
    <div className="mx-auto  min-h-180 bg-white border-2 border-[#89A8B2] shadow-xl rounded-2xl overflow-hidden ">
      ...
      {/* 🔥 Top Navbar */}
      <div className="flex justify-between p-6 items-center mb-4 bg-[#89A8B2] py-3">
      ...
      <div className="flex justify-center mb-4">
        <img
          src={image}
          alt={name}
          className="h-70 object-contain transition duration-300"
        />
      </div>
      ...
      <div className="mt-6 text-center p-4 ">
        ...
        <div className="grid grid-cols-4 gap-2 text-sm mt-6">
